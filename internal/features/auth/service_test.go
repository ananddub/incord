...
func TestRegister(t *testing.T) {
	...
	userID, tokens, err := svc.Register(ctx, "testuser", "test@example.com", "password123")
...
func TestRegisterDuplicateEmail(t *testing.T) {
	...
	_, _, err := svc.Register(ctx, "user1", "dup@example.com", "pass123")
	require.NoError(t, err)

	_, _, err = svc.Register(ctx, "user2", "dup@example.com", "pass123")
	assert.Error(t, err)
}
...
func TestRegisterDuplicateUsername(t *testing.T) {
	...
	_, _, err := svc.Register(ctx, "sameuser", "a@example.com", "pass123")
	require.NoError(t, err)

	_, _, err = svc.Register(ctx, "sameuser", "b@example.com", "pass123")
	assert.Error(t, err)
}
...
func TestLogin(t *testing.T) {
	...
	_, _, err := svc.Register(ctx, "loginuser", "login@example.com", "mypassword")
	require.NoError(t, err)
...
func TestLoginWrongPassword(t *testing.T) {
	...
	_, _, err := svc.Register(ctx, "wrongpass", "wrong@example.com", "correctpass")
	require.NoError(t, err)
...
func TestRefreshToken(t *testing.T) {
	...
	_, tokens, err := svc.Register(ctx, "refreshuser", "refresh@example.com", "pass123")
	require.NoError(t, err)
...
func TestRefreshTokenUsedTwice(t *testing.T) {
	...
	_, tokens, err := svc.Register(ctx, "doubleref", "double@example.com", "pass123")
	require.NoError(t, err)
...
func TestLogout(t *testing.T) {
	...
	_, tokens, err := svc.Register(ctx, "logoutuser", "logout@example.com", "pass123")
	require.NoError(t, err)
...
func TestValidateToken(t *testing.T) {
	...
	_, tokens, err := svc.Register(ctx, "validateuser", "validate@example.com", "pass123")
	require.NoError(t, err)
