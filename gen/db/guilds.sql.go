...
VALUES ($1, $2, $3, $4)
RETURNING id, name, description, icon_url, owner_id, created_at, deleted, updated_at, banner_url
`
...
SELECT id, name, description, icon_url, owner_id, created_at, deleted, updated_at, banner_url FROM guilds WHERE id = $1 AND deleted = FALSE
`
